...
# Surprisals
For GPT (and some others), run get_surps.sh.
```{r}
# For models
...
gpt_translator <- read_tsv(here(prep_dir,"gpt_surp_trans.txt"), col_names=c("Story_Num","Sentence_Num","Word_In_Sentence_Num","Word_In_Story_Num","Word","Token", "Surprisal")) %>% 
