...
By-factor GAMs fail to run overnight / crash the R session. 
...
model_1 <- lmer(rt ~ surp_center * length_center + length_center * freq_center +
                 ...
                 past2_surp_center * past2_length_center + past2_length_center * past2_freq_center + 
                  ...
                  (1|subject)+(1|Word_ID), data=d)
return(model_1)
}

m_ngram <- run_lm(all_spr,"5-gram")
m_grnn <- run_lm(all_spr, "GRNN")
m_txl <- run_lm(all_spr,"TXL")
m_gpt <- run_lm(all_spr,"GPT-2")
...
data=readRDS("spr_pre_brms.rds")
 priors <- c(
      set_prior("normal(300, 100)", class="Intercept"),
...
run_model <- function(model_spec,data,file_name){
  ...
  m1 <- brm(rt ~ surp_center * length_center + length_center * freq_center +
                 ...
                 past2_surp_center * past2_length_center + past2_length_center * past2_freq_center + 
                  past3_surp_center * past3_length_center + past3_length_center * past3_freq_center + 
              (surp_center * length_center + length_center * freq_center +
                  past_surp_center * past_length_center + past_length_center * past_freq_center + 
                 past2_surp_center * past2_length_center + past2_length_center * past2_freq_center + 
                  past3_surp_center * past3_length_center + past3_length_center * past3_freq_center |subject)+(1|Word_ID),
            data=d,
            file=file_name,
            prior=priors,
            control=list(adapt_delta=.95))
