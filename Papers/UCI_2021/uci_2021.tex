...
\end{itemize}\pause 
	...
	\node[xshift=-2cm,yshift=0cm] at (current page.east) {\includegraphics[clip, trim=.1cm 0cm .2cm 0cm,width=.2\textwidth]{../Images/roger.jpg}};
	\end{tikzpicture}
		\begin{tikzpicture}[remember picture,overlay]
	\node[xshift=-2cm,yshift=2cm] at (current page.south east) {\includegraphics[clip, trim=.1cm 0cm .2cm 0cm,width=.2\textwidth]{../Images/richard.jpg}};
	\end{tikzpicture}
	\begin{tikzpicture}[remember picture,overlay]
	\node[xshift=-2cm,yshift=-2cm] at (current page.north east) {\includegraphics[width=.3\textwidth]{../Images/cpl_header.png}};
	\end{tikzpicture}
