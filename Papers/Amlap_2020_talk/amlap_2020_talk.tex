...
\pause
Want a measure of processing difficulty \greencheck\pause
...
LSTM RNNs show some syntactic knowledge %TODO cite people 
\pause
...
\begin{itemize}
	\item Treat whole story as a unit: ~ No one makes it to the end. \pause
	\item Treat each sentence as a unit: Some participants miss key context. \pause
\end{itemize}
