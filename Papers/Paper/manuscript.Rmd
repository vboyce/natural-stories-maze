...
We constructed A-maze distractors for the Natural Stories corpus [@futrellNaturalStoriesCorpus2020] and recruited 100 crowd-sourced participants to each read a story in the error-correction Maze paradigm. The materials, data, and analysis code are all available at https://osf.io/gfs87/?view_only=c04ea31c7ea34d9ba84eb106f88b564a <!--https://github.com/vboyce/natural-stories-maze-->. 
...
(ref:gam-grid) Generalized Additive Model main effects and two-way interactions among frequency, length, and surprisal for A-Maze reading of the Natural Stories corpus. Confidence bands do not take into account the uncertainty associated with `mgcv` hyperparameter estimation [@wood:2017GAMs].
