...
(ref:spr-gam-cap) GAM predictions of reaction time (RT) for SPR data from @futrellNaturalStoriesCorpus2020 as a function of either current word surprisal (top) or previous word surprisal (bottom). Density of data is shown along the x-axis. TODO replace graph!
